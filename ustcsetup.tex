...
\ustcsetup{
  ...
  title              = {基于龙芯架构的\\NuttX操作系统移植与优化},
  title*             = {Porting and Optimization of \\NuttX Operating System \\Based on LoongArch},
  author             = {刘庆涛},
  author*            = {Liu Qingtao},
  professional-type  = {电子信息},
  professional-type* = {Electronic Information},
  speciality         = {计算机技术},
  speciality*        = {Computer Technology},
  supervisor         = {杨盘隆},
  supervisor*        = {Prof. Yang Panlong},
  advisor            = {张福新},
  advisor*           = {Prof. Zhang Fuxin},
